$(document).ready(function () {
    ...
    $('.faq-question').on('click', function() {
        ...
        $('.faq-item').not(faqItem).each(function() {
            ...
            $(this).find('.faq-question').removeClass('font-semibold text-gray-900').addClass('font-medium text-gray-700');
        ...
        if (isOpen) {
            ...
            $(this).removeClass('font-semibold text-gray-900').addClass('font-medium text-gray-700');
            ...
            $(this).removeClass('font-medium text-gray-700').addClass('font-semibold text-gray-900');
